...
public class RpcHelperTest {
	...
	public void testGetJSONArray() throws JSONException {
		...
		Item one = new ItemBuilder().setItemId("one").setAddress("160 Morgan st").setRating(5).setCategories(category).build();
		Item two = new ItemBuilder().setItemId("two").setAddress("160 Morgan st").setRating(5).setCategories(category).build();
